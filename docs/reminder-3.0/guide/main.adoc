...
A new code list is introduced as an addition to codes part of UNCL7161 named "Reminder charge reason code" used to indicate charges added as part of the reminder. The new code list contains only the code "REM", and is used in BT-98|BT-105.
