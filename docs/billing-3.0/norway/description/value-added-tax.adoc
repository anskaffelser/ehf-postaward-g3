...
Please see the link:http://docs.peppol.eu/poacc/billing/3.0/bis/#_value_added_tax_vat[PEPPOL BIS Billing 3.0 documentation] for more information about value added tax.