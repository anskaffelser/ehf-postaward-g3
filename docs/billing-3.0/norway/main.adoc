...
Since EHF Fakturering 3.0 is equal to PEPPOL BIS Billing 3.0 all the issues, bugs or comments to the specification need to be reported
link:https://openpeppol.atlassian.net/servicedesk/customer/portal/1[here], by using "Request for Change (RFC)".
