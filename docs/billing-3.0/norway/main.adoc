...
Norwegian organizations may download the following parts of EN16931:

* link:https://online.standard.no/nb/ns-en-16931-1-2017a1-2019ac-2020[Electronic invoicing - Part 1: Semantic data model of the core elements of an electronic invoice]
* link:https://online.standard.no/nb/sn-cents-16931-2-2017[Electronic invoicing - Part 2: List of syntaxes that comply with EN 16931-1]
