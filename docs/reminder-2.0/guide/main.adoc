...
<cac:PaymentMeans>
    ...
    <cac:PayeeFinancialAccount>
            <cbc:ID>05111125551</cbc:ID> <2>
            <cbc:Name>Ola Nordmenn</cbc:Name>
            <cac:FinancialInstitutionBranch>
                <cbc:ID>BIC32201</cbc:ID> <3>
            </cac:FinancialInstitutionBranch>
    </cac:PayeeFinancialAccount>
</cac:PaymentMeans>
----
<1> Payment means code
<2> The account number, IBAN (International Bank Account Number) or a national account number (BBAN = Basic Bank Account Number)
<3> BIC or a national clearing code
