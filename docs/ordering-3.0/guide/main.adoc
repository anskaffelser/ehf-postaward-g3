...
{name-difi-en}
v3.0.0 RC
:description: This document describes the new version of EHF Ordering (called "EHF Ordre"). The document is part of Norwegian "Agency of Public Management and eGovernment" (Difi) standardization work related to electronic commerce.
:doctype: book
:icons: font
:toc: left
:toclevels: 2
...
include::appendix/Appendix-A.adoc[]
